...
@override_settings(
    ...
    FRONTEND_LAGAUFRE_WIDGET_PATH="https://static.example.com/lagaufre.js",
    FRONTEND_LAGAUFRE_WIDGET_API_URL="https://example.com/api/services",
    FRONTEND_MEET_BASE_URL="https://meet.example.com",
